      ...
      if (device.date_to_renew) {
        ...
        if (!isNaN(renewDate)) {
          ...
          renewalsTimeline[monthKey].items.push({
            ...
            name: device.m2m_name || device.final_client || 'Sin Nombre',
            uuid: device.uuid,
  ...
  return (
    <div className="space-y-6 p-4 animate-fade-in pb-10">
      ...
      <TableCard
        ...
        columns={[
          {
            ...
            render: (r) => (
              <div>
                ...
                <div className="font-semibold text-gray-700">{r.m2m_name || r.final_client || '-'}</div>
              </div>
            ),
          },
        ...
        searchableKeys={['m2m_name', 'final_client', 'uuid', 'model_name', 'status_label']}
